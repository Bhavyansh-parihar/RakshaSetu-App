      ...
      <div className="p-6 flex flex-col gap-5 max-w-[1440px] w-full mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4" style={{ minHeight: 400 }}>
          ...
          <div className="xl:col-span-2 bg-card rounded-lg border border-border overflow-hidden flex flex-col">
            ...
            {/* Map area */}
            <div className="flex-1 relative bg-slate-100 overflow-hidden" style={{ minHeight: 300 }}>
              {/* Grid lines */}
              ...
              {/* Legend */}
              <div className="absolute bottom-3 left-3 bg-white/95 border border-slate-200 shadow-md rounded-lg px-3 py-2 flex flex-col gap-1.5">
                {[
              ...
              {/* Coordinates */}
              <div className="absolute top-2 right-3 font-mono text-[10px] text-slate-500 font-medium">
                25.5941°N · 85.1376°E
              </div>
            </div>
          </div>
