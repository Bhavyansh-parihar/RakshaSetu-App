  ...
  return (
    <div className="p-6 max-w-[1440px] mx-auto flex flex-col gap-5">
      ...
      <div className="bg-card border border-border rounded-lg overflow-hidden">
        ...
        <div className="relative bg-[#07101E]" style={{ height: 280 }}>
          ...
          {/* Legend */}
          <div className="absolute bottom-4 left-4 bg-black/75 rounded-lg px-3 py-2">
            <div className="text-[10px] font-mono text-white/60 mb-1.5 uppercase">Rainfall Intensity</div>
            <div className="flex items-center gap-3">
              {[
                ...
                <div key={l.label} className="flex items-center gap-1">
                  ...
                  <span className="text-[9px] text-white/50 font-mono">{l.label}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="absolute top-3 right-4 font-mono text-[10px] text-blue-400/40">
