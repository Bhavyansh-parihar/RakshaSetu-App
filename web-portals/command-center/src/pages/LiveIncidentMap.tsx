  ...
  return (
    <div className="flex h-full relative">
      ...
      <div className="flex-1 relative bg-slate-100 overflow-hidden">
        ...
        {/* District label */}
        <div className="absolute top-4 left-1/2 -translate-x-1/2 font-mono text-[11px] text-slate-500 font-medium tracking-widest uppercase">
        ...
        <div className="absolute top-10 right-4 bg-white/95 border border-slate-200 shadow-md rounded-lg p-3">
          <div className="text-[10px] font-mono text-slate-500 uppercase tracking-wider mb-2">Active Incidents</div>
          {[
        ...
        {/* Legend */}
        <div className="absolute bottom-4 left-4 bg-white/95 border border-slate-200 shadow-md rounded-lg px-3 py-2.5 flex flex-col gap-1.5">
          {[
            ...
            <div key={l.label} className="flex items-center gap-2">
              ...
              />
              <span className="text-[10px] text-slate-700 font-mono font-medium">{l.label}</span>
            </div>
          ))}
        </div>
        ...
        <div className="absolute bottom-4 right-4 font-mono text-[10px] text-slate-500 text-right">
          ...
          <div className="mt-0.5 text-slate-400">Zoom: District Level</div>
        </div>
      </div>
